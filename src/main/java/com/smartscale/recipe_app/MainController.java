...
public class MainController {
    ...
    /** Build the recipe steps. targetWeight in grams; 0 means no weight required. */
    public void createRecipeSteps() {
        // Using the steps text you provided earlier. Indices correspond to the array below.
